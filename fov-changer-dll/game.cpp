...
// For hooks
static InputListener* g_refInputListener = nullptr;
    ...
    if (g_refInputListener)
    {
        ...
        if (keyCode == 72)
        {
            ...
            else
            {
                ...
                *g_refInputListener->m_pointerCapture_p = 1;
...
GameManager::GameManager()
{
    ...
    this->m_inputListener = std::make_shared<InputListener>(this);
}

InputListener::InputListener(GameManager* gameManager)
    : m_gameManager(gameManager),
      m_moduleBase(gameManager->m_moduleBase),
      m_keyMappings((KeyMappings*)(gameManager->m_moduleBase + 0x036529B0))
{
}
...
void InputListener::initGameData()
{
    ...
    m_pointerCapture_p = (byte*)mem::FindDMAAddy(m_gameManager->m_moduleBase + 0x03A27CF8, { 0, 0x18, 0, 0x110, 0x2E0, 0x8, 0x48 + 2 });
